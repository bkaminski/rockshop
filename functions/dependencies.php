...
//LOAD SCRIPTS
function enqueue_craving_scripts() {
...
add_action('wp_enqueue_scripts', 'enqueue_craving_scripts');

//LOAD CSS
function enqueue_craving_styles() {
...
add_action('wp_enqueue_scripts', 'enqueue_craving_styles');
